...
class InternshipRepository(
    ...
    // ==========================================
    // Internships - PERBAIKAN: Hapus authToken dari parameter GET
    // ==========================================
    override suspend fun getInternships(
        ...
        SuspendHelper.safeApiCall {
            apiService.getInternships(search, page, perPage, category, location)
        }

    override suspend fun getInternshipById(
        internshipId: String
    ): ResponseMessage<ResponseInternship?> =
        SuspendHelper.safeApiCall {
            apiService.getInternshipById(internshipId)
        }

    override suspend fun postInternship(
        authToken: String,
        request: RequestInternship
    ): ResponseMessage<ResponseInternshipAdd?> =
        SuspendHelper.safeApiCall {
            apiService.postInternship("Bearer $authToken", request)
        }

    override suspend fun putInternship(
        authToken: String,
        internshipId: String,
        request: RequestInternship
    ): ResponseMessage<String?> =
        SuspendHelper.safeApiCall {
            apiService.putInternship("Bearer $authToken", internshipId, request)
        }

    override suspend fun putInternshipCover(
        authToken: String,
        internshipId: String,
        file: MultipartBody.Part
    ): ResponseMessage<String?> =
        SuspendHelper.safeApiCall {
            apiService.putInternshipCover("Bearer $authToken", internshipId, file)
        }

    override suspend fun deleteInternship(
        authToken: String,
        internshipId: String
    ): ResponseMessage<String?> =
        SuspendHelper.safeApiCall {
            apiService.deleteInternship("Bearer $authToken", internshipId)
        }
    ...
    override suspend fun getMyApplications(
        ...
        SuspendHelper.safeApiCall {
            apiService.getMyApplications("Bearer $authToken", page, perPage)
        }
    ...
    override suspend fun postApplication(
        ...
        SuspendHelper.safeApiCall {
            apiService.postApplication("Bearer $authToken", request)
        }
    ...
    override suspend fun deleteApplication(
        ...
        SuspendHelper.safeApiCall {
            apiService.deleteApplication("Bearer $authToken", applicationId)
        }

    override suspend fun putApplicationCV(
        authToken: String,
        applicationId: String,
        file: MultipartBody.Part
    ): ResponseMessage<String?> =
        SuspendHelper.safeApiCall {
            apiService.putApplicationCV("Bearer $authToken", applicationId, file)
        }
}